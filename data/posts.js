...
export const POSTS = [
  {
    ...
    likes: 7543,
    caption:
      'Train Ride to Hogwarts. 😂🤖, this is my ig clone, that is really enjoying',
    profile_picture: USERS[0].image,
    comments: [
      {user: 'saints_bandd', comment: 'OO bratan vapweekuu 🔥'},
      {
        user: 'diyor_sultonov94',
  ...
  },
  {
    ...
    comments: [
      {user: 'olimjon_1225', comment: 'OO bratan vapweekuu 🔥, bzani jiyan'},
      {
        user: 'diyor_sultonov94',
